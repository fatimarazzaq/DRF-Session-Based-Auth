"""
Django settings for s_auth_backend project.
...
SECRET_KEY = 'django-insecure-0c7-99#$v&5$at8g)3n(@vybo-9*ggcsv88&2p$jb(o2d5(*fz'
...
ROOT_URLCONF = 's_auth_backend.urls'
...
WSGI_APPLICATION = 's_auth_backend.wsgi.application'
